...
const Experience: React.FC = () => {
  ...
  return (
    <section id="experience" className="py-24" style={{background: 'linear-gradient(to bottom right, #91AC8F, #B2C9AD)'}}>
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            {/* Timeline Line */}
            <div className="absolute left-8 top-0 bottom-0 w-0.5 hidden md:block" style={{backgroundColor: '#4B5945'}}></div>
