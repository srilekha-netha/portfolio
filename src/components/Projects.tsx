          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t opacity-20 group-hover:opacity-30 transition-opacity duration-300" style={{backgroundColor: project.gradient}}></div>
                
                {/* Project Icon */}
                <div className="absolute top-4 left-4 p-3 rounded-xl text-green-800 shadow-lg" style={{backgroundColor: project.gradient}}>
                  {project.icon}
                </div>
              </div>
